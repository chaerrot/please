...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		 아래 코드는 자동형변환이 아님. CPU는 int보다 작은 자료형을
		...
		/*
		 명시적 형변환: 큰 상자의 자료를 작은 상자의 자료형에 할당해야할 때
		...
		/*
		 		서식문자 사용 시 %.2f: 정수부는 모두 표현하고
		 			소수 이하 2자리까지만 표현하겠다는 의미임.
		 */
		
		
		/*
		 char와 int를 연산하면 결과는 int형이므로 char형 변수에
		 결과를 대입하려면 반드시 명시적 형변환을 한 후 진행해야 한다.
		 */
		char ch3 = 'A', ch4;
		int num4 = 2;

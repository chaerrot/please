	...
	public static void main(String[] args) {
		...
		/*
		 char형: 하나의 문자를 저장할 수 있는 자료형으로 값을 저장할 때
		 	...
		 	만약 "(double qoutation)으로 감싸면 문자열로 인식하므로
		 	String으로 선언해야 한다.
		 */
		char ch1 = '가';
		// char chStr = '가나다라'; // 에러발생. 문자열이므로 char로 선언불가능.
		String chStr = "가나다라"; // String으로 선언해야 함.
		...
		System.out.println("ch3(아스키코드 출력)=> "+ (int)ch3); // 67 출력됨.
		
		char ch4 = '1'; // 싱글 쿼테이션으로 감쌌으므로 문자 1이 할당됨.
		char ch4_1 = '1' + 1; // 49 + 1

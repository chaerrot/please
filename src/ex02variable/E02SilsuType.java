...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 실수자료형
		 - 정수형보다는 실수형이 더 큰 자료형이다. (0과 1 사이에 무수히
		 	많은 실수가 존재하기 때문이다.)
		...
		/*
		 ...
		 방법2: 계산 결과 전체를 long형으로 강제(명시적)형변환 한다.
		 */
		...
		// float f4 = 3.14; // 에러 발생] 3.14 자체를 double형으로 인식함.
		float f4 = (float)3.14; // 형변환 후 대입가능함 (권장사항 아님.)

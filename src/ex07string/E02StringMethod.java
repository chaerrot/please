...
public class E02StringMethod 
{
	public static void main(String[] args) 
	{
		 ...
		 */
		System.out.println("str1의 두 번째 문자:" 
				+ str1.charAt(1));
		System.out.println("str2의 두 번째 문자:" 
				+ str2.charAt(1));
		...
		/*
		 14] codePointAt(인덱스) : 문자열의 특정 인덱스의 문잘르 찾은 후
		 	아스키코드(유니코드)를 반환한다.
		 */
		System.out.println("### codePointAt() ###");
		System.out.println("str1 첫 번째 문자의 아스키코드: "+ str1.codePointAt(0));
		System.out.println("str1 첫 번째 문자의 아스키코드: "+ str2.codePointAt(0));

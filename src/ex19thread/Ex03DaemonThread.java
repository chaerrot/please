...
class YesThread extends Thread {
	...
	public YesThread() {}
	/*
	 Thread클래스의 생성자를 호출할 때 전달하는 매개변수를 통해 해당
...
/*
 종속쓰레드(Daemon Thread)
 	...
 	종료될 때까지는 프로그램은 종료된 것이 아니다.
 	주로 프로그램의 보조 역할로 배경음악, 로그자동저장 등의 업무를
	...
	public void run()
	{
		while (true) {
			...
			try {
				...
				System.out.println("자동저장시 오류발생ㅜ");
			}
		}
	}
}

	...
	public void run() {
		for (int i=1; i<=1000; i++) {
			...
			/*
			 ...
			 sleep()메서드를 사용하게 되면 실행 중 잠깐씩 블럭 상태로
...
public class Ex02Priority
{
	public static void main(String[] args)
	{
		...
		/*
		 3단계실행
		 	: 정수 대신 static(정적) 상수를 사용하여 우선순위를 부여할 수도
		 	있다. 결과는 2단계와 동일하다.1`
		 */
//		MessageSendingThread tr1 = 
//			new MessageSendingThread("첫번째", Thread.MAX_PRIORITY);
//		MessageSendingThread tr2 = 
//			new MessageSendingThread("두번째", Thread.MAX_PRIORITY);
//		MessageSendingThread tr3 = 
//			new MessageSendingThread("세번째", Thread.MAX_PRIORITY);

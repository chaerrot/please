...
/*
 Wrapper 클래스
 	...
 	클래스로 Boxing 혹은 Unboxing을 통해 기본 자료를 객체화한다.
 */
public class E01WrapperClass1
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 JDK1.5 이후 버전에서의 코딩 형태. 오토박싱 혹은 오토언박싱이
		...
		System.out.println("오토언박싱 이후 연산 결과: "+ result3);
		...
		/*
		 ...
		 toString():ㅣ 인스턴스 변수를 출력할 때 참조값이 아니라

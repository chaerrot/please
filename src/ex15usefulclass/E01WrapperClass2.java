...
public class E01WrapperClass2
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 ...
		 위와 동일한 예외가 발생한다.
		 */
		//System.out.println(Integer.parseInt(floatString)); //error //예외발생
		System.out.println("실수형(float)형으로 변경: " 
				+ Float.parseFloat(floatString));
		System.out.println("실수형(Doulbe)형으로 변경: " 
		...
		/*
		 isDigit(): 인자로 전달된 문자가 숫자인지 판단한다. 숫자일 때
		 	true를 반환한다.
		 */
		...
		/*
		 isLowerCaser(): 소문자인지 판단.
		 isUpperCase(): 대문자인지 판단.
		 	단, 영문자가 아닌 경우 false를 반환한한다.
		 */

...
class SingleTone {
	...
	/*
	 ...
	 없으므로, new 키워드를 통해 객체를 생성할 수 없게 된다.
	 */
	private SingleTone() {
		//기본생성자
	}
...
public class E03SingleToneDesignPattern
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println(String.format("st2의 shaerVar: %d", st2.shareVar));
		System.out.println(String.format("st3의 shaerVar: %d", st3.shareVar));
	}

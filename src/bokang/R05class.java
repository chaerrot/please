...
public class R05class
{
	public static void main(String[] args)
	{
		/*
		 ...
		 JDK7부터 지원되었으며 숫자 사이에 쓰는 것만 허용된다.
		 잘못된방법]
		 	3._14159
		 	123_456_
		 	_123_456
		...
		cc1.cardNumber = 4815_4672_2574_4557L;
		cc1.owner = "홍길동";
		cc1.balace = 10000;
		cc1.point = 0;
		...
		cc2.payment(9000);
		cc2.showState();
		//멤버변수가 private으로 정보은닉되었으므로 접근 불가능
		//cc2.Balace() = 100000000; //에러발생
		//cc2.Point() = 300000; //에러발생
		
		/*
		 위와 같이 초기화 메서드를 사용하면 객체 생성, 초기화를 별도로 진행해야 하지만
		 생성자를 사용하면 초기화까지 동시에 진행할 수 있다. 즉 객체생성은
		 생성자를 사용하는게 좋다.
		 */

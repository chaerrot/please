...
public class R03method
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println(inputNum+ "까지의합은: "+ total);
		...
		*/
		...
		System.out.println("연습문제(업글구구)_T");
		upgradeGugu_T();
		
	}////end of main
	
	//메서드 타입3: 세 과목의 평균값을 반환하는 메서드
	...
	public static void upgradeGugu() {
		...
		for (int a=2; a<=9; a++) {
			for (int b=1; b<=9; b++) {
				if (a==b) {
					for (int c=1; c<=b; c++) {
						System.out.printf("%2d*%d=%2d ", a, c, (a*c));
					}
					System.out.println();
				}
			}

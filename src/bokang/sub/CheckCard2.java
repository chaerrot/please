...
public class CheckCard2
{
	...
	/*
	 ...
	 붙여 놓고 시작한다. 차후 반환타입이 있는  경우 void를 해당 반환타입으로 
	 변경하면 된다.
	 */
	public void initMembers(long cardNumber, String owner, int balace, int point) {
		//멤버변수를 멤버메서드에서 사용할 땐 무조건 this를 붙여주면 좋다.
	...
	/*
	 ...
	 source > generate constructor (using Fields..) > 생성하기
	 */
	//기본생성자(디폴트생성자)
	public CheckCard2() {}
	//인자생성자

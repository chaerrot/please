...
public class R01if
{
	public static void main(String[] args)
	{
		...
		int num1 = 10;
		int num2 = 20;
		if (num1<num2) {//조건이 true일 때 해당 구문이 실행됨.
		...
		/*
		 시나리오] 90점 이상: A학점
		 	...
		 	아래와 같이 구간을 조건식으로 사용하면 위치에 상관 없이
		 ...
		 */
		/*
		 시나리오] 월에 해당하는 1~12까지의 숫자를 입력 받아서
		...
		switch (month)
		{
		case 3: case 4: case 5: //if문의 or(||)조건 같은 형식

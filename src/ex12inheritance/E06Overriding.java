...
/*
 오버라이딩 (Overriding)
 	...
 	오버로딩과 다른 점은 매개변수의 개수, 반환타입 등이 완전히
 	똑같은 형태로 재정의한다는 것이다.
 	하위클래스에서 오버라이딩한 메서드는 상위클래스인 메서드를
...
class BaseSpeaker extends Speaker {
	...
	public void showState() {
		/*
		 ...
		 특히, 오버라딩된 메서드를 호출할 때 super가 없으면 
...
public class E06Overriding
{
	...
	public static void main(String[] args)
	{
		...
		baseSpeaker.showState(); /*
			...
			showState()메서드가 호출된다. 부모 쪽의 메서드는
			가려지게 된다.
		*/
		...
		/*
		 ...
		 부모타입으로 자식 객체를 참조하면 접근 범위가 부모 객체까지로

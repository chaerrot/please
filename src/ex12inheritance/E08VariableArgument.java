...
/*
 가변인자 (Variable Argument)
 	...
 	JDK1.5부터 지원한다.
 	- 매개변수는 여러 개를 한꺼번에 받아야하므로 배열로 반환된다.
 */
public class E08VariableArgument
{
	...
	public static void main(String[] args)
	{
		...
		//매개변수의 타입에 double이 포함되어 호출 불가능함.
		//System.out.println("getTotal(ar) 호출: "+ getTotal(10, 20.3));
		//정수타이보가 실수타입까지 처리하려면 가변인자의 타입은 double로 하면 된다.

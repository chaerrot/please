...
public class E07RideAndLoad02
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 정적메서드는 클래스명을 통해 호출한다. static의 기본 규칙을
		 따르므로, 오버라딩의 대상이 될 수 없다.
		 */
		...
		parent.walk();
		//parent.walk(20); //자식 쪽에 정의된 메서드이므로 접근 불가

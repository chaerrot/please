...
class Account {
	/*
	 ...
	 클래스 내부에서만 접근할 수 있다. 즉 상속 받은 하위클래스에서는
	 직접 접근이 불가능하다.
	 */
	private int money; 
	...
	//private으로 선언된 멤버변수를 외부로 반환할 때 사용환다. (getter()메서드)
...
class SavingAccount extends Account {
	...
	/*
	 ...
	 사용한다. 이 때 인자가 하나인 부모클래스의 생성자를 호출한다.
	 */
	...
	/*
	 private 멤버변수인 money는 자식 쪽으로 직접 접근할 수 없으므로

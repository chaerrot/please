...
class AbsClassChild1 extends AbsClass1 {
	...
	@Override
	void instanceMethod() {
		System.out.println("필요 없다면 오버라이딩하지 않아도 상관 없다.");
	}
}
/*
...
/*
 위 클래스를 상속하면 부모가 가진 추상메서드를 그대로 상속 받게 되므로
 해당 클래스를 abstract로 선언해야 한다. 단, 이 경우 해당 클래스로도
...
public class E01AbstractBasic
{
	public static void main(String[] args)
	{
		...
		//부모 타입으로 자식 객체에 접근하려면 다운캐스팅해야 한다.
		((AbsClassChild2)absClass2).newMethod();
		
		/*
		 추상클래스 내에 선언된 정적멤버메서드는 오버라이딩의 대상이
		 아니므로 static의 기본 규칙을 따른다. 즉 클래스명으로 접근하면
		 된다.
		 */

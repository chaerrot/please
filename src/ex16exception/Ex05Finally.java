...
/*
 	...
 	: 예외 발생과 상고나 없이 try문에 진입했을 때 반드시 실행해야
 	할 코드가 있는 경우 기술하는 블럭이다.
 	즉 try문으로 진입하지 않는다면 finally절을 실행되지 않는다.
 */
public class Ex05Finally
{
	/*
	 런타임 예외가 발생되는 메소드. 예외 발생 시 
	...
	static void tryCatchFinally() {
		...
		try {
			...
			/*
			 try문 진입 후 예외발생 여부에 상관 없이 해당 구문은 실행된다.
